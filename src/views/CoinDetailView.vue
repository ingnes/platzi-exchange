<template>
  <div class="flex-col">
    ...
    <template v-if="!loading">
      ...
      <px-best-offerts-table :markets="markets"></px-best-offerts-table>
    </template>
  </div>
</template>
...
import PxBestOffertsTable from '@/components/PxBestOffertsTable.vue'

export default {
  name: 'CoinDetail',

  components: { PulseLoader, PxBestOffertsTable },
